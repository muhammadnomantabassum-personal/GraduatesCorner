...
export default function NewCompanyPhDPositionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      router.push("/dashboard/company/phd-positions")
    }
  }
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-6">
        <Link
          href="/dashboard/company/phd-positions"
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-6 flex items-center justify-between">
          <Link href="/dashboard/company/phd-positions">
