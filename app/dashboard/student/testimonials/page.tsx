...
export default function StudentTestimonialsPage() {
  ...
  const handleEditApproved = () => {
    if (approvedTestimonial) {
      ...
      setIsEditing(false) // Adding new pending from approved content
      setShowForm(true)
    }
  }
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Share your experience with GradNexus
          </p>
        </div>
      ...
      {!hasAnyTestimonial && !showForm && (
        <div className="mb-6 flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/[0.03] p-4">
          ...
          <div className="text-xs leading-relaxed text-muted-foreground">
            ...
            <p className="mt-1">
              You can submit feedback about your experience with GradNexus.
          ...
          <CardContent className="p-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Textarea
                  id="content"
                  placeholder="Tell us about your experience with GradNexus..."
                  rows={4}
                  value={content}
        ...
        <div className="mb-6">
          ...
          <Card className="border-emerald-200/50 bg-emerald-50/20 dark:border-emerald-900/20 dark:bg-emerald-950/10">
            <CardContent className="p-5">
              ...
              <div className="relative">
                <Quote className="absolute -left-1 -top-1 h-6 w-6 text-emerald-400/40" />
                <p className="pl-6 text-sm leading-relaxed text-foreground">
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="mb-5 max-w-sm text-sm text-muted-foreground">
              Share your experience with GradNexus to help other students
