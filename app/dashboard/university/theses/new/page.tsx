...
export default function NewUniversityThesisPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      router.push("/dashboard/university/theses")
    }
  }
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-6">
        <Link
          href="/dashboard/university/theses"
        ...
        <h1 className="text-xl font-bold text-foreground font-sans">Post a Master Thesis</h1>
          ...
          <CardContent className="flex flex-col gap-5 p-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                id="url"
                type="url"
                placeholder="https://your-university.edu/apply"
                required
                value={externalUrl}
