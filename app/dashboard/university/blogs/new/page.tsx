...
export default function NewUniversityBlogPage() {
  const { user } = useAuth()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      router.push("/dashboard/university/blogs")
    }
  }
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-6">
        <Link
          href="/dashboard/university/blogs"
        ...
        <p className="text-sm text-muted-foreground">
          Share news, research highlights, or insights from your university
        </p>
      </div>
      ...
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/[0.03] p-4">
        ...
        <div className="text-xs leading-relaxed text-muted-foreground">
          <p className="font-medium text-foreground">How blog posting works</p>
          <p className="mt-1">
            Your blog post will be reviewed by our admin team before publishing.
            Once approved, it will appear on the public blog page for all visitors to read.
            You can track the status of your submissions in the My Blogs section.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-6 flex items-center justify-between">
          <Link href="/dashboard/university/blogs">
