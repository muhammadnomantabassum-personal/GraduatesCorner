...
export default function UniversityBlogsPage() {
  const { user } = useAuth()
        ...
        {tabs
          ...
          .map((tab) => (
            <button
              ...
              className={`flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-md px-3 py-1.5 text-xs font-medium transition-colors ${activeTab === tab.key
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-10 text-center sm:py-16">
            ...
            <p className="mb-5 text-sm text-muted-foreground">
              {activeTab === "all"
                ? "Start writing to share your university's insights"
