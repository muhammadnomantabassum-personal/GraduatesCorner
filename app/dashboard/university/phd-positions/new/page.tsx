...
export default function NewUniversityPhDPositionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      router.push("/dashboard/university/phd-positions")
    }
  }
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mb-6">
        <Link
          href="/dashboard/university/phd-positions"
        ...
        <h1 className="text-xl font-bold text-foreground">Post a PhD Position</h1>
        <p className="text-sm text-muted-foreground">
          Create a new PhD position for students to discover
        </p>
      </div>
      ...
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/[0.03] p-4">
        ...
        <div className="text-xs leading-relaxed text-muted-foreground">
          <p className="font-medium text-foreground">How PhD position posting works</p>
          <p className="mt-1">
            Your PhD position will be reviewed by our admin team before publishing.
            Once approved, it will appear on the public PhD positions page for students to browse.
            You can track the status of your submissions in the PhD positions section.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardContent className="flex flex-col gap-5 p-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Textarea
                id="description"
                placeholder="Describe the PhD research topic, requirements, expected outcomes, and candidate qualifications..."
                rows={6}
                required
                value={description}
        ...
        <div className="mt-6 flex items-center justify-between">
          <Link href="/dashboard/university/phd-positions">
