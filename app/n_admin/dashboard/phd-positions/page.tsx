    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-5 flex items-center gap-1 overflow-x-auto rounded-lg border border-border bg-muted/40 p-1 scrollbar-none">
        ...
        <button
          ...
          className={`flex shrink-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-md px-3 py-2 text-xs font-medium transition-all ${activeTab === "rejected"
            ? "bg-background text-foreground shadow-sm"
            : "text-muted-foreground hover:text-foreground"
            }`}
        >
          ...
          Rejected
          {rejected.length > 0 && (
            <span className={`rounded-full px-1.5 py-0.5 text-[10px] font-semibold ${activeTab === "rejected"
      ...
      {loading ? (
        ...
        <div>
          {rejected.length > 0 ? (
            <div className="flex flex-col gap-3">
              {rejected.map((thesis) => (
                <Card key={thesis.id} className="border-l-[3px] border-l-destructive/70">
                  <CardContent className="p-5">
                    <div className="flex flex-col gap-3">
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="mb-1 flex items-center gap-2">
                            <Badge className="bg-destructive/10 text-[10px] font-medium text-destructive hover:bg-destructive/10">
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                <XCircle className="mb-3 h-10 w-10 text-destructive/30" />
                <p className="text-sm font-medium text-foreground">No rejected PhD positions</p>
              </CardContent>
            </Card>
          )}
        </div>
