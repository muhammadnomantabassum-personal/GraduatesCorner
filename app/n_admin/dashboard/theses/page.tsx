    ...
    <div className="mx-auto max-w-4xl">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="mt-4 text-muted-foreground text-sm">Loading theses...</p>
        </div>
      ) : activeTab === "approved" ? (
        <div>
          {approved.length > 0 ? (
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-sm font-medium text-foreground">No approved theses</p>
              </CardContent>
            </Card>
          )}
        </div>
          ...
          {pending.length > 0 ? (
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">No theses waiting for approval</p>
              </CardContent>
            </Card>
          )}
        </div>
