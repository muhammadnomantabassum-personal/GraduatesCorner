...
const faqCategories = [
  {
    ...
    items: [
      {
        q: "What is Graduates Corner?",
        a: "Graduates Corner is a platform that connects students with thesis positions and trainee programs offered by universities and companies across Scandinavia and beyond. We make it easy to discover, compare, and apply for academic and professional opportunities.",
      },
      {
        q: "Is Graduates Corner free to use?",
        a: "Yes, Graduates Corner is completely free for students. Universities and companies can create accounts and list opportunities at no cost during our launch phase. Premium features for organizations may be introduced in the future.",
      },
      {
      ...
      <section className="border-b border-border bg-primary px-4 py-14 text-primary-foreground lg:py-18">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto max-w-lg text-[15px] text-primary-foreground/60">
            Everything you need to know about Graduates Corner. Can&apos;t find what you&apos;re
            looking for?{" "}
