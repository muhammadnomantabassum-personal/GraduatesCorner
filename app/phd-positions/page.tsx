...
import { Search, SlidersHorizontal, X, Loader2, GraduationCap, Building2, MapPin, Microscope, Heart } from "lucide-react"
  ...
  return (
    <PublicLayout>
      <section className="relative overflow-hidden px-4 py-16 text-primary-foreground lg:py-20">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_76%_20%,rgba(251,188,5,0.20),transparent_20rem)]" />
