    ...
    <PublicLayout>
      ...
      <section className="border-b border-border bg-primary px-4 py-12 text-primary-foreground lg:py-16">
        <div className="mx-auto max-w-7xl">
          <h1 className="mb-3 text-3xl font-bold lg:text-4xl">PhD Positions</h1>
          <p className="mb-6 text-lg text-primary-foreground/80">
            Find PhD positions and doctoral opportunities from universities and research institutions worldwide
          </p>
