    ...
    <PublicLayout>
      <section className="border-b border-border bg-primary px-4 py-16 text-primary-foreground lg:py-20">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <h1 className="mb-4 text-balance text-3xl font-bold lg:text-5xl">About Graduates Corner</h1>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Over 120 partner universities and companies trust Graduates Corner to connect them
      ...
      <section className="px-4 py-16 lg:py-20">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-xl text-muted-foreground">
            Join thousands of students, universities, and companies already using Graduates Corner.
          </p>
